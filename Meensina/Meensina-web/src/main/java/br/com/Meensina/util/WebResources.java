...
public final class WebResources implements Serializable {
	...
	private static final long serialVersionUID = -1106057468833181014L;
    ...
    public static Flash getFlashContext(){
    ...
    public static Usuario getSessionUsuario(){
    	...
    	UsuarioLoginBean usuarioLoginBean =  (UsuarioLoginBean) WebResources.getSession().getAttribute(WebResources.USUARIOLOGIN);
    	return usuarioLoginBean.getUsuario();
    }
